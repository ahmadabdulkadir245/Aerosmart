...
function Cart() {
  ...
  return (
    <div className=''>
      <Header />
      <div className='pt-5 lg:grid grid-cols-3 gap-x-6 m-auto  lg:max-w-7xl max-h-[calc(100vh-132px)] lg:h-full transition-all duration-500 ease-in overflow-y-scroll scrollbar-hide'>
      ...
      onClick={checkoutHandler}>Buy Now | <TbCurrencyNaira  className="w-5 h-5"/>{cartTotal.toLocaleString()}
            ...
            {/* slider */}
            <DiscountSlider sectionTitle={'Top Selling'} products={[]} />
